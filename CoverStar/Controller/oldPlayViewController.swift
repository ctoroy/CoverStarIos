...
class oldPlayViewController: UIViewController {
    ...
    func getData(contestId: String, sort:String) {
        
        self.castList.removeAll()
        popupManager.showLoadingView()
        
        httpTool.getLastList(contestId:contestId,sort: sort) { (succeed, castList, resultInfo) in
...
extension oldPlayViewController : UITableViewDelegate
{
...
extension oldPlayViewController : UITableViewDataSource
{
...
extension oldPlayViewController: UITableViewDataSourcePrefetching {
  func tableView(_ tableView: UITableView,
